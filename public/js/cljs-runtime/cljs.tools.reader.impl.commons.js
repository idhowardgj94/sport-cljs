...
var G__41547 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__41547;
continue;
} else {
return ch;
...
var vec__41536 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41536,(0),null);
return (match === s);
});
...
var G__41566 = (i__4737__auto___41563 + (1));
i__4737__auto___41563 = G__41566;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq41545){
...
return (function() { 
var G__41569__delegate = function (rdr,_){
...
var G__41569 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__41570__i = 0, G__41570__a = new Array(arguments.length -  1);
while (G__41570__i < G__41570__a.length) {G__41570__a[G__41570__i] = arguments[G__41570__i + 1]; ++G__41570__i;}
  _ = new cljs.core.IndexedSeq(G__41570__a,0,null);
} 
return G__41569__delegate.call(this,rdr,_);};
G__41569.cljs$lang$maxFixedArity = 1;
G__41569.cljs$lang$applyTo = (function (arglist__41571){
var rdr = cljs.core.first(arglist__41571);
var _ = cljs.core.rest(arglist__41571);
return G__41569__delegate(rdr,_);
});
