...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__41344 = c;
var G__41344__$1 = (((G__41344 == null))?null:G__41344.prototype);
if((G__41344__$1 == null)){
return null;
} else {
return G__41344__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__41346 = c;
var G__41346__$1 = (((G__41346 == null))?null:G__41346.prototype);
if((G__41346__$1 == null)){
return null;
} else {
return G__41346__$1.render;
}
})() == null)))));
});
...
G__41371.cljs$lang$applyTo = (function (arglist__41373){
...
var or__4126__auto__ = (function (){var G__41349 = c;
var G__41349__$1 = (((G__41349 == null))?null:G__41349.constructor);
if((G__41349__$1 == null)){
return null;
} else {
return G__41349__$1.displayName;
}
})();
...
var G__41350 = c;
var G__41350__$1 = (((G__41350 == null))?null:G__41350.constructor);
if((G__41350__$1 == null)){
return null;
} else {
return G__41350__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__41351 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__41352 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__41352);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__41351);
}});
reagent.impl.component.rat_opts = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"no-cache","no-cache",1588056370),true], null);
reagent.impl.component.custom_wrapper = (function reagent$impl$component$custom_wrapper(key,f){
var G__41353 = key;
var G__41353__$1 = (((G__41353 instanceof cljs.core.Keyword))?G__41353.fqn:null);
switch (G__41353__$1) {
...
var c = this;
var G__41356_41382 = goog.object.get(c,"cljsRatom");
if((G__41356_41382 == null)){
} else {
reagent.ratom.dispose_BANG_(G__41356_41382);
}
...
var renders_41385 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_41386 = cljs.core.first(cljs.core.vals(renders_41385));
...
if((cljs.core.count(renders_41385) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_41385))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_41386)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_41386], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__41357 = o;
goog.object.set(G__41357,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__41358 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__41359 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__41359);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__41358);
}});
...
var vec__41360 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41360,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41360,(1),null);
...
var G__41363 = goog.object.get(reagent_state,"cljsRatom");
if((G__41363 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__41363);
}
});
}),[]);
