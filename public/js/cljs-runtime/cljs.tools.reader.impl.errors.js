...
var len__4736__auto___41513 = arguments.length;
var i__4737__auto___41514 = (0);
while(true){
if((i__4737__auto___41514 < len__4736__auto___41513)){
args__4742__auto__.push((arguments[i__4737__auto___41514]));

var G__41515 = (i__4737__auto___41514 + (1));
i__4737__auto___41514 = G__41515;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq41395){
var G__41396 = cljs.core.first(seq41395);
var seq41395__$1 = cljs.core.next(seq41395);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41396,seq41395__$1);
}));
...
var G__41531 = (i__4737__auto___41527 + (1));
i__4737__auto___41527 = G__41531;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq41418){
var G__41419 = cljs.core.first(seq41418);
var seq41418__$1 = cljs.core.next(seq41418);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41419,seq41418__$1);
}));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq41420){
var G__41421 = cljs.core.first(seq41420);
var seq41420__$1 = cljs.core.next(seq41420);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41421,seq41420__$1);
}));
...
var i__4737__auto___41542 = (0);
while(true){
if((i__4737__auto___41542 < len__4736__auto___41540)){
args__4742__auto__.push((arguments[i__4737__auto___41542]));

var G__41543 = (i__4737__auto___41542 + (1));
i__4737__auto___41542 = G__41543;
continue;
} else {
}
break;
...
var init = (function (){var G__41439 = kind;
var G__41439__$1 = (((G__41439 instanceof cljs.core.Keyword))?G__41439.fqn:null);
switch (G__41439__$1) {
case "regex":
return "#\"";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41439__$1)].join('')));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq41436){
...
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41437,G__41438,seq41436__$2);
}));
...
var iter__4529__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__41475(s__41476){
return (new cljs.core.LazySeq(null,(function (){
var s__41476__$1 = s__41476;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__41476__$1);
if(temp__5753__auto__){
var s__41476__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__41476__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__41476__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__41478 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__41477 = (0);
while(true){
if((i__41477 < size__4528__auto__)){
var vec__41479 = cljs.core._nth(c__4527__auto__,i__41477);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41479,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41479,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__41478,id);

var G__41554 = (i__41477 + (1));
i__41477 = G__41554;
continue;
} else {
var G__41555 = (i__41477 + (1));
i__41477 = G__41555;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41478),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__41475(cljs.core.chunk_rest(s__41476__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41478),null);
}
} else {
var vec__41482 = cljs.core.first(s__41476__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41482,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41482,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__41475(cljs.core.rest(s__41476__$2)));
} else {
var G__41560 = cljs.core.rest(s__41476__$2);
s__41476__$1 = G__41560;
continue;
}
}
} else {
