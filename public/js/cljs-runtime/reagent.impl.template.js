...
var G__41379 = o;
goog.object.set(G__41379,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__41405__delegate = function (args){
...
while (G__41406__i < G__41406__a.length) {G__41406__a[G__41406__i] = arguments[G__41406__i + 0]; ++G__41406__i;}
  args = new cljs.core.IndexedSeq(G__41406__a,0,null);
} 
return G__41405__delegate.call(this,args);};
G__41405.cljs$lang$maxFixedArity = 0;
G__41405.cljs$lang$applyTo = (function (arglist__41407){
var args = cljs.core.seq(arglist__41407);
return G__41405__delegate(args);
});
...
var G__41380 = o;
goog.object.set(G__41380,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__41412__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__41412 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__41413__i = 0, G__41413__a = new Array(arguments.length -  0);
while (G__41413__i < G__41413__a.length) {G__41413__a[G__41413__i] = arguments[G__41413__i + 0]; ++G__41413__i;}
  args = new cljs.core.IndexedSeq(G__41413__a,0,null);
} 
return G__41412__delegate.call(this,args);};
G__41412.cljs$lang$maxFixedArity = 0;
G__41412.cljs$lang$applyTo = (function (arglist__41414){
var args = cljs.core.seq(arglist__41414);
return G__41412__delegate(args);
});
G__41412.cljs$core$IFn$_invoke$arity$variadic = G__41412__delegate;
return G__41412;
})()
;
} else {
...
var G__41381 = props;
var G__41381__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41381,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__41381);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41381__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__41383 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41383,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__41383;
}
})(),id_class);
...
var G__41384 = (cljs.core.count(argv) - first_child);
switch (G__41384) {
case (0):
...
var vec__41387 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41387,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41387,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41387,(2),null);
...
var temp__5757__auto___41421 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___41421 == null)){
} else {
var key_41422 = temp__5757__auto___41421;
(jsprops.key = key_41422);
}
...
var temp__5757__auto___41423 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___41423 == null)){
} else {
var key_41424 = temp__5757__auto___41423;
(jsprops.key = key_41424);
}
...
var temp__5757__auto___41425 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___41425 == null)){
} else {
var key_41426 = temp__5757__auto___41425;
(jsprops.key = key_41426);
}
...
var temp__5757__auto___41431 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___41431 == null)){
} else {
var key_41432 = temp__5757__auto___41431;
(jsprops.key = key_41432);
}
...
var temp__5757__auto___41433 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___41433 == null)){
} else {
var key_41437 = temp__5757__auto___41433;
(jsprops.key = key_41437);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41390_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__41390_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__41391 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41391,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41391,(1),null);
...
break;
default:
var G__41448 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__41449 = compiler;
v = G__41448;
compiler = G__41449;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template41402 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template41402 = (function (opts,id,fn_to_element,meta41403){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template41402.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_41404,meta41403__$1){
var self__ = this;
var _41404__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template41402(self__.opts,self__.id,self__.fn_to_element,meta41403__$1));
}));

(reagent.impl.template.t_reagent$impl$template41402.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_41404){
var self__ = this;
var _41404__$1 = this;
return self__.meta41403;
}));

(reagent.impl.template.t_reagent$impl$template41402.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template41402.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template41402.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template41402.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template41402.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta41403","meta41403",-1625438931,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template41402.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template41402.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template41402");

(reagent.impl.template.t_reagent$impl$template41402.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template41402");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template41402.
 */
reagent.impl.template.__GT_t_reagent$impl$template41402 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template41402(opts__$1,id__$1,fn_to_element__$1,meta41403){
return (new reagent.impl.template.t_reagent$impl$template41402(opts__$1,id__$1,fn_to_element__$1,meta41403));
});

}

return (new reagent.impl.template.t_reagent$impl$template41402(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
